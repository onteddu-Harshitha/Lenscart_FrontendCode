...
export class AuthService {
  ...
  registerCustomer(customer: any): Observable<any> {
    return this.http.post(`${this.baseUrl}/register/customer`, customer); // Customer registration endpoint
  }
  ...
  return payload ? payload.username || payload.email || payload.sub : null;
}
